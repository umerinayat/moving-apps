...
<head>
    ...
    <title>Moving Streams - Tools | Convert Web Page Content to Full Image</title>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <form id="form" class="form-signin text-center mt-5">
                        <h1 class="h3 mb-3 fw-normal">Convert Web Page Content to Full Image, Enter Your Webpage URL.</h1>

                        <div class="form-floating">
                            <input type="text" class="form-control" id="urlInput" name="url" placeholder="example.com">
                            <label for="urlInput">Webpage URL</label>
                        </div>
                        <p id="errorText" class="mt-2 text-danger" style="display: none;"> <strong>Please Enter Valid Webpage URL</strong> </p>
